...
export const GetStarted = () => {
  ...
  return (
    <div className="grid grid-cols-1 lg:grid-cols-3 px-5 lg:px-10 py-8 h-screen gap-10">
      ...
      <div className="lg:col-span-1 h-full">
        <div className="flex flex-col items-start  justify-center h-full gap-10 lg:gap-20 w-full lg:w-3/4 xl:w-1/2">
      ...
      <div className="lg:hidden pt-15 pb-4 md:items-center flex flex-col">
        ...
        <p className="text-body-medium text-black-400 pt-1 text-center">
          Next: Create your first property
        </p>
      </div>
    </div>
