  ...
  const ActivateAgentContent = (
    <div className="p-6 flex gap-4 flex-col">
      ...
      <p className="text-body-base-normal text-black-300">
        Are you sure you want to activate this agent? This agent will be able
        to list units under your property
      </p>
